  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Each piece is carefully selected and crafted with attention to
                detail
              </p>
            </div>
            <div className="text-center space-y-4">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/gradient-pattern.dim_1200x600.png)",
        }}
      >
        ...
        <div className="relative z-10 container text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Browse our collection of handcrafted items and find something
            special
          </p>
          <Button asChild size="lg" className="gap-2">
            <Link to="/products">
